...
class Registration extends Component {
  ...
  componentDidMount = async () => {
    ...
    const result = await axios('/api/v2/users/profile');
    const { data } = result;
    const {
  ...
  render() {
    ...
    const {
      disable, email, rule, previewVisible, fileList, previewImage, password, mobile, address, first, last, jobtitle, username,
    } = this.state;
